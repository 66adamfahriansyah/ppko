  ...
  client.on('message', async (topic, message) => {
    if (topic === MQTT_TOPIC) {
      try {
        ...
        const isTelemetry = payload.type === 'telemetry' || payload.aggregate !== undefined || payload.nodes !== undefined || payload.rain !== undefined;
        ...
        if (isTelemetry) {
          ...
          // Simpan data valid ke database (tanpa baterai/PLTS)
